...
if(req.url === '/api/login' || req.url === '/api/register' || req.url === '/api/register/sendMail' || req.url === '/api/register/verify' || req.url.includes('/images') || req.url.includes('api-docs') || req.url === '/api/forgotPassword/sendMail' || req.url === '/api/forgotPassword/verify' || req.url === '/api/resetPassword' || req.url === '/api/test'){
    return next()
