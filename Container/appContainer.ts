...
import billServiceImpl from '../utilities/ServiceClient/billServiceImpl'
...
container.bind<BillsPayment>('BillsPayment').to(BillsPaymentImpl)
container.bind<billService>('billService').to(billServiceImpl)
